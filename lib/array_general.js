...
Array.prototype.hasAlmostDuplicates = function(accuracy) {
	return this.some((currentNumber, i) =>
		this.slice(i + 1).some(otherNumber => currentNumber.isAlmostEqual(otherNumber, accuracy))
	);
};
