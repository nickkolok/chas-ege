...
nabor.importFrom({
    ...
    resourceAddress: '../zdn/matege2024p/', // Адрес
...
nabor.categories = {
    noDerivative: 'Без производной', // Категория: Без производной
    noLogarithms: 'Без логарифмов', // Категория: Без логарифмов
    noTrigonometry: 'Без тригонометрии', // Категория: Без тригонометрии
    noFractionalPowers: 'Без дробных степеней', // Категория: Без дробных степеней
};

nabor.disabledItems = []; // Массив для выключенных элементов
nabor.alternativeTasks = []; // Массив для альтернативных заданий
