...
function addinitjs(){
	document.write('<div id="document-write"></div>');
	if(svinta){
...
var znachok="";
document.write('<link rel="shortcut icon" id="link_icon1" href="'+znachok+'"/>');//В оффлайн-режиме в хроме работает через base64 и больше никак.
document.write('<link rel="icon" id="link_icon2" href="'+znachok+'"/>');
...
window.chas.version="20150202032446"
window.chas.version="20150203030031"
window.chas.version="20150203032507"
window.chas.version="20150203032801"
window.chas.version="20150203033745"
