...
lx['одинаковое стекло']={
	ie:'одинаковое стекло',
	re:'одинакового стекла',
	de:'одинаковому стеклу',
	ve:'одинаковое стекло',
	te:'одинаковым стеклом',
	pe:'одинаковом стекле',
	im:'одинаковые стёкла',
	rm:'одинаковых стёкол',
	dm:'одинаковым стёклам',
	vm:'одинаковые стёкла',
	tm:'одинаковыми стёклами',
	pm:'одинаковых стёклах',
	rod:2,
	odu:0,
};
lx['оконная рама']={
