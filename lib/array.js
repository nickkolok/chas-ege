...
Array.prototype.joinWithConjunction = function(conjunction) {
	/** Соединяет массив запятыми и соединяет для последних элемента союзом conjunction*/
	/** ["a=5","b=1","c=9"].joinWithConjunction() => "a=5, b=1 и c=9"*/
	return this.joinLast(conjunction);
}
