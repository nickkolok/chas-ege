...
CanvasRenderingContext2D.prototype.drawTetrahedron = function(o, dottedLine, setLineDash, height, apothem) {
	...
	let angle1 = 180 - o.angle / 2;

	let sideCoordinates = [
		[0, o.side, o.side * (o.angle).cos(), o.side * (o.angle).sin()], //1
		[o.side * (o.angle).cos(), o.side * (o.angle).sin(), -o.side * (angle1).cos(), o.side * (angle1).sin()], //2
		[-o.side * (angle1).cos(), o.side * (angle1).sin(), 0, o.side], //3

		[0, o.side, o.side * (30).cos(), o.side * (30).sin() / 2], //4
		[o.side * (o.angle).cos(), o.side * (o.angle).sin(), o.side * (30).cos(), o.side * (30).sin() / 2], //5
		[-o.side * (angle1).cos(), o.side * (angle1).sin(), o.side * (30).cos(), o.side * (30).sin() / 2], //6
	];

	for (let i = 0; i < sideCoordinates.length; i++) {
	...
	if (height) {
		this.setLineDash(setLineDash);
		this.drawLine(o.side * (30).cos(), o.side * (30).sin() / 2, o.side * (30).cos(), -(6).sqrt() * o.side * (30).sin() /
			4);

		this.drawLine(0, o.side, o.side * (30).cos(), -(6).sqrt() * o.side * (30).sin() / 4);
		this.drawLine(o.side * (o.angle).cos(), o.side * (o.angle).sin(), o.side * (30).cos(), -(6).sqrt() * o.side * (30).sin() /
			4);
		this.drawLine(-o.side * (angle1).cos(), o.side * (angle1).sin(), o.side * (30).cos(), -(6).sqrt() * o.side * (30).sin() /
			4);
		this.setLineDash([]);
	}
	if (apothem) {
		this.drawLine(o.side * (30).cos(), o.side * (30).sin() / 2, o.side * (60).cos() / 2, -(3).sqrt() * o.side * (30).sin() /
			2.4);
	}
};
