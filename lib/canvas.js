...
CanvasRenderingContext2D.prototype.rightPyramid4 = function(o, dottedLine, setLineDash, height, apothem) {
	...
	*/
	...
	let edgeCoordinates = [
		...
		[o.edge, -o.edge, o.edge + o.edge * (o.angle).cos(), -o.edge * (o.angle).sin()], //правая 2
		[o.edge * (o.angle).cos(), -o.edge * (o.angle).sin(), o.edge * (o.angle).cos() + o.edge, -o.edge * (o.angle).sin()], //верхняя 3

		[0, -o.edge, o.edge * (o.angle / 1.5).cos(), -1.5 * o.edge * (o.angle).sin() + o.height], //левая к вершине 4
		[o.edge, -o.edge, o.edge * (o.angle / 1.5).cos(), -1.5 * o.edge * (o.angle).sin() + o.height], //нижняя к вершине 5
		[o.edge * (o.angle).cos(), -o.edge * (o.angle).sin(), o.edge * (o.angle / 1.5).cos(), -1.5 * o.edge * (o.angle).sin() +
			o.height
		], //верхняя к вершине 6
		[o.edge * (o.angle).cos() + o.edge, -o.edge * (o.angle).sin(), o.edge * (o.angle / 1.5).cos(), -1.5 * o.edge * (o.angle)
			.sin() + o.height
		], //правая к вершине 7
	...
	if (height) {
		...
		this.drawLine(o.edge * (o.angle / 1.5).cos(), -1.5 * o.edge * (o.angle).sin() +
			o.height, o.edge * (o.angle / 1.5).cos(), -0.5*(o.edge+o.edge * (o.angle).sin()));
		this.drawLine(0, -o.edge, o.edge * (o.angle).cos() + o.edge, -o.edge * (o.angle).sin());
		this.drawLine(o.edge * (o.angle).cos(), -o.edge * (o.angle).sin(), o.edge, -o.edge);
		this.setLineDash([]);
	}

	if (apothem) {
		this.drawLine(o.edge / 2, -o.edge, o.edge * (o.angle / 1.5).cos(), -1.5 * o.edge * (o.angle).sin() +
			o.height);
	}
