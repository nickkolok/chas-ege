...
CanvasRenderingContext2D.prototype.drawParallelepiped = function(o, dottedLine, diagonal) {
	...
	if (diagonal) {
		...
		this.drawLine(0, 0, o.depth * Math.cos(o.angle) + o.width, o.depth / 2 + o.height);
		this.setLineDash([]);
	...
	let sideCoordinates = [
		...
		[0, o.height, o.depth * Math.cos(o.angle), o.depth / 2 + o.height], //4
		[o.width, o.height, o.depth * Math.cos(o.angle) + o.width, o.depth / 2 + o.height], //5
		[0, 0, o.depth * Math.cos(o.angle), o.depth / 2], //6
		[o.width, 0, o.depth * Math.cos(o.angle) + o.width, o.depth / 2], //7
		[o.depth * Math.cos(o.angle), o.depth / 2, o.depth * Math.cos(o.angle), o.depth / 2 + o.height], //8
		[o.depth * Math.cos(o.angle) + o.width, o.depth / 2, o.depth * Math.cos(o.angle) + o.width, o.depth / 2 + o.height], //9
		[o.depth * Math.cos(o.angle), o.depth / 2, o.depth * Math.cos(o.angle) + o
		.width, o.depth / 2], //10
		[o.depth * Math.cos(o.angle), o.depth / 2 + o.height, o.depth * Math.cos(o.angle) + o.width, o.depth / 2 + o.height] //11
	];
