...
CanvasRenderingContext2D.prototype.arcBetweenSegments = function(coordinates, radius) {
	...
	case 4:
		...
		let result = XY.coordinatesOfIntersectionOfTwoSegments();
		x = result.x;
		y = result.y;
	}
...
CanvasRenderingContext2D.prototype.rightPyramid3 =
CanvasRenderingContext2D.prototype.drawRightPyramid3 = function(o, dottedLine, setLineDash, drawHeight, drawApothem) {
	...
	*/
	...
	let vertex = [
		[0, -o.edge],
		[o.edge, -o.edge],
		[o.edge * o.angle.cos(), -o.edge * o.angle.sin()],
		[(o.edge * o.angle.cos() + o.edge) / 3, (-o.edge * o.angle.sin() - 2 * o.edge) / 3 + o.height],
		[(o.edge * o.angle.cos() + o.edge) / 3, (-o.edge * o.angle.sin() - 2 * o.edge) / 3, (o.edge * o.angle.cos() +o.edge) / 3, (-o.edge * o.angle.sin() - 2 * o.edge) / 3 + o.height]
	];
	...
	if (o.lettersOnVertex.length) {
		for (let i = 0; i < o.lettersOnVertex.length; i++) {
			let step = (i < 3) ? 10 / o.scale : -10 / o.scale;
			this.fillText(o.lettersOnVertex[i], vertex[i][0], vertex[i][1] + step, 20);
		}
	}
};

CanvasRenderingContext2D.prototype.rightPyramid4 =
...
CanvasRenderingContext2D.prototype.drawPrism6 = function(o, dottedLine, setLineDash) {
	...
	o.angleCamera = o.angleCamera || Math.PI / 6;
	let edgeCos = o.depth * (o.angle).sin();
	let edgeSin = o.depth * (o.angle).cos();

	let vertex = [
		[0, 0],
		[edgeCos, -edgeSin],
		[2 * o.width, -edgeSin],
		[2 * o.width + edgeCos * (o.angleCamera).sin(), 0],
		[2 * o.width + edgeCos * (o.angleCamera).sin() - edgeCos, edgeSin],
		[edgeCos * (o.angleCamera).sin(), edgeSin],
	];

	let edgeCoordinates = [
		[0, 0, edgeCos, -edgeSin], //0
		[edgeCos, -edgeSin, 2 * o.width, -edgeSin], //1
		[2 * o.width, -edgeSin, 2 * o.width + edgeCos * (o.angleCamera).sin(), 0], //2
		[2 * o.width + edgeCos * (o.angleCamera).sin(), 0, 2 * o.width + edgeCos * (o.angleCamera).sin() - edgeCos, edgeSin], //3
		[2 * o.width + edgeCos * (o.angleCamera).sin() - edgeCos, edgeSin, edgeCos * (o.angleCamera).sin(), edgeSin], //4
		[edgeCos * (o.angleCamera).sin(), edgeSin, 0, 0] //5
	];

	edgeCoordinates.forEach((elem, index) => {
		if (dottedLine.includes(index))
			this.setLineDash(setLineDash);
		this.drawLine(elem[0], elem[1], elem[2], elem[3]);
		this.setLineDash([]);
	...
	edgeCoordinates.forEach((elem, index) => {
		if (dottedLine.includes(index + 6))
			this.setLineDash(setLineDash);
		this.drawLine(elem[0], elem[1] + o.height, elem[2], elem[3] + o.height);
		this.setLineDash([]);
	});
	edgeCoordinates.forEach((elem, index) => {
		if (dottedLine.includes(index + 12))
			this.setLineDash(setLineDash);
		this.drawLine(elem[0], elem[1], elem[0], elem[1] + o.height);
		this.setLineDash([]);
	});
	...
	if (o.lettersOnVertex.length) {
		for (let i = 0; i < o.lettersOnVertex.length / 2; i++) {
			let step = 2 * o.height / o.scale;
			this.fillText(o.lettersOnVertex[i], vertex[i][0], vertex[i][1] + o.height + step, 20);
		}
		for (let i = o.lettersOnVertex.length / 2; i < o.lettersOnVertex.length; i++) {
			let step = -o.height / o.scale;
			this.fillText(o.lettersOnVertex[i], vertex[i - 6][0], vertex[i - 6][1] + step, 20);
		}
	}
};
...
CanvasRenderingContext2D.prototype.rightPyramid3 = function(o, dottedLine, setLineDash, height, apothem) {
	/*Функция отрисовки правильной треугольной пирамиды
	...
	*/
	...
	let edgeCoordinates = [
		...
		[0, -o.edge, (o.edge * (o.angle)
			.cos() + o.edge) / 3, (-o.edge * (o.angle).sin() - 2 * o.edge) / 3 + o.height], //левая к вершине3
		[o.edge, -o.edge, (o.edge * (o.angle)
			.cos() + o.edge) / 3, (-o.edge * (o.angle).sin() - 2 * o.edge) / 3 + o.height], //правая к вершине 4
		[o.edge * (o.angle).cos(), -o.edge * (o.angle).sin(), (o.edge * (o.angle).cos() + o.edge) / 3, (-o.edge * (o.angle)
			.sin() - 2 * o.edge) / 3 + o.height] //верхняя к вершине 5

	];

	if (height) {
		this.setLineDash(setLineDash);
		this.drawLine((o.edge * (o.angle).cos() + o.edge) / 3, (-o.edge * (o.angle).sin() - 2 * o.edge) / 3, (o.edge * (o.angle)
			.cos() + o.edge) / 3, (-o.edge * (o.angle).sin() - 2 * o.edge) / 3 + o.height);
		this.drawLine(o.edge * (o.angle).cos(), -o.edge * (o.angle).sin(), o.edge / 2, -o.edge); //нижняя
		this.drawLine(0, -o.edge, 0.5 * (o.edge + o.edge * (o.angle).cos()), 0.5 * (-o.edge - o.edge * (o.angle).sin())); //правая
		this.drawLine(o.edge, -o.edge, 0.5 * o.edge * (o.angle).cos(), 0.5 * (-o.edge - o.edge * (o.angle).sin())); //левая
		this.setLineDash([]);
	...
	if (apothem) {
		this.drawLine(o.edge / 2, -o.edge, (o.edge * (o.angle).cos() + o.edge) / 3, (-o.edge * (o.angle).sin() - 2 * o.edge) /
			3 + o.height);
	}
...
CanvasRenderingContext2D.prototype.rightPyramid6 = function(o, dottedLine, setLineDash, height, apothem) {
	/*Функция отрисовки правильной шестиугольной пирамиды
	...
	if (o.angle === undefined || o.angle == Math.PI / 2 || o.angle == 3 * Math.PI / 2)
		o.angle = Math.PI / 6;
	let edgeCos = o.edge * (o.angle).sin();
	let edgeSin = o.edge * (o.angle).cos();
	let edgeCoordinates = [
		//TODO: fix edges
		[0, 0, edgeCos, edgeSin], //левая верхняя 0 
		[0, 0, edgeCos, -edgeSin], //левая нижняя 1
		[edgeCos, edgeSin, 2 * o.edge, edgeSin], //верхняя 2 
		[edgeCos, -edgeSin, 2 * o.edge, -edgeSin], //нижняя 3
		[2 * o.edge, edgeSin, edgeCos + 2 * o.edge, 0], //правая верхняя 4 
		[2 * o.edge, -edgeSin, edgeCos + 2 * o.edge, 0], //правая нижняя 5

		[0, 0, 0.5 * (edgeCos + 2 * o.edge), o.height], //левая к вершине  6
		[edgeCos, edgeSin, 0.5 * (edgeCos + 2 * o.edge), o.height], //левая верхняя к вершине 7 
		[edgeCos, -edgeSin, 0.5 * (edgeCos + 2 * o.edge), o.height], //левая нижняя к вершине 8
		[2 * o.edge, edgeSin, 0.5 * (edgeCos + 2 * o.edge), o.height], //правая верхняя к вершине 9
		[2 * o.edge, -edgeSin, 0.5 * (edgeCos + 2 * o.edge), o.height], //правая нижняя к вершине 10
		[edgeCos + 2 * o.edge, 0, 0.5 * (edgeCos + 2 * o.edge), o.height], //правая к вершине 11
	];

	if (height) {
		this.setLineDash(setLineDash);
		this.drawLine(0.5 * (edgeCos + 2 * o.edge), 0, 0.5 * (edgeCos + 2 * o.edge), o.height);

		this.drawLine(0, 0, (edgeCos + 2 * o.edge), 0);
		this.drawLine(edgeCos, edgeSin, 2 * o.edge, -edgeSin);
		this.drawLine(edgeCos, -edgeSin, 2 * o.edge, edgeSin);
		this.setLineDash([]);
	}

	if (apothem) {
		this.drawLine(0.5 * edgeCos, -0.5 * edgeSin, 0.5 * (edgeCos + 2 * o.edge), o.height);
	}
...
CanvasRenderingContext2D.prototype.drawPrism = function(o, dottedLine, setLineDash) {
	...
	let sideCoordinates = [
		[0, 0, 0, o.height], //0
		[0, 0, o.depth * o.angle.cos(), o.depth / 2], //1
		[0, 0, o.depth * o.angle.cos() + o.width, o.depth / 2], //2
		[0, o.height, o.depth * o.angle.cos(), o.depth / 2 + o.height], //3
		[0, o.height, o.depth * o.angle.cos() + o.width, o.depth / 2 + o.height], //4
		[o.depth * o.angle.cos(), o.depth / 2, o.depth * o.angle.cos(), o.depth / 2 + o.height], //5
		[o.depth * o.angle.cos() + o.width, o.depth / 2, o.depth * o.angle.cos() + o.width, o.depth / 2 + o.height], //6
		[o.depth * o.angle.cos(), o.depth / 2, o.depth * o.angle.cos() + o.width, o.depth / 2], //7
		[o.depth * o.angle.cos(), o.depth / 2 + o.height, o.depth * o.angle.cos() + o.width, o.depth / 2 + o.height] //8
	];
	...
	if (o.lettersOnVertex.length) {
		for (let i = 0; i < o.lettersOnVertex.length; i++) {
			let step = (i < o.lettersOnVertex.length / 2) ? 2 * o.height / o.scale : -o.height / o.scale;
			this.fillText(o.lettersOnVertex[i], vertex[i][0], vertex[i][1] + step, 20);
		}
	}
};
