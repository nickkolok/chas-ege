class Triangle {
    constructor({ points, lengths, angles}) {
    ...
    _calculateBisectors() {
        this._bisectorA = this._calculateBisector(this._pointA, this._sideBC, this._angleA);
        this._bisectorB = this._calculateBisector(this._pointB, this._sideCA, this._angleB);
        this._bisectorC = this._calculateBisector(this._pointC, this._sideAB, this._angleC);
    }
