class Triangle {
    ...
    get angleAInDegrees() {
        return this._angleAInRadians * (180 / Math.PI);
    }

    get angleBInDegrees() {
        return this._angleBInRadians * (180 / Math.PI);
    }

    get angleCInDegrees() {
        return this._angleCInRadians * (180 / Math.PI);
    }
    ...
    get semiperimeter() {
        return this.perimeterTriangle / 2;
    }
