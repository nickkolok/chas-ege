class Triangle {
    ...
    constructor({ points = [], lengths = {}, angles = {}, supplementary = {} }) {
        ...
        switch (true) {
            ...
            case Object.keys(lengths).length == 2 && typeof angleValues === 'number':
                this._createFromTwoSidesAndAngle(lengths, angleValues);
                break;
    ...
    _createFromSideLengths(sideAB, sideBC, sideCA) {
        if (!isValidTriangle(sideAB, sideBC, sideCA)) {
            throw new Error("Three sides do not form a triangle");
        }

        this.#lengthAB = sideAB;
        this.#lengthBC = sideBC;
        this.#lengthCA = sideCA;
    ...
    _createFromTwoSidesAndAngle(lengths, angleBetween) {
        const { lengthAB, lengthBC, lengthCA } = lengths;
        ...
        switch (true) {
            case (lengthAB > 0 && lengthBC > 0):
                side1 = lengthAB;
                side2 = lengthBC;
                side3 = calculateThirdSide(side1, side2, angleRadians);
                this.#lengthCA = side1;
                this.#lengthAB = side2;
                this.#lengthBC = side3;
                break;
    ...
    get midlineStartPointAB() {
        return this.midlineAB.startPoint.coordinates;
    }

    get midlineStartPointBC() {
        return this.midlineBC.startPoint.coordinates;
    }

    get midlineStartPointCA() {
        return this.midlineCA.startPoint.coordinates;
    }
    ...
    get midlinePointsAB() {
        return [this.midlineStartPointAB, this.midlineEndPointAB];
    }
    
    get midlinePointsBC() {
        return [this.midlineStartPointBC, this.midlineEndPointBC];
    }
    
    get midlinePointsCA() {
        return [this.midlineStartPointCA, this.midlineEndPointCA];
    }

    get midlineABLength() {
        return this.lengthAB/2;
    }

    get midlineBCLength() {
        return this.lengthBC/2;
    }

    get midlineCALength() {
        return this.lengthCA/2;
    }
