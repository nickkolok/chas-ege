class Triangle {
    ...
    _createFromPoints(pointA, pointB, pointC) {
        ...
        this._lengthAB = this.#sideAB.length;
        this._lengthBC = this.#sideBC.length;
        this._lengthCA = this.#sideCA.length;
    ...
    _createFromSideLengths(sideA, sideB, sideC) {
        ...
        [this.#pointA, this.#pointB, this.#pointC] = findTriangleVertices2D(this._lengthAB, this._lengthBC, this._lengthCA);
    ...
    _calculateMedians() {
        ...
        this._medianA = new Segment(this.#pointA, midPointBC);
        this._medianB = new Segment(this.#pointB, midPointCA);
        this._medianC = new Segment(this.#pointC, midPointAB);
    }
    ...
    _calculateHeights() {
        ...
        this._heightA = new Segment(this.#pointA, footA);
        this._heightB = new Segment(this.#pointB, footB);
        this._heightC = new Segment(this.#pointC, footC);
    }
    ...
    get vertices() {
        [this.#pointA.coordinates, this.#pointB.coordinates, this.#pointC.coordinates]
    }
