...
function chislitM(p1,p2,p3,p4,separator,tex,nots){
...
/***/
	...
	switch(options){
		case 'r': return chislitM(p1,	rez.re,	 rez.rm,				rez.rm, separator, tex, nots);
		case 'd': return chislitM(p1,	rez.de,	 rez.dm,				rez.dm, separator, tex, nots);
		case 'v': return chislitM(p1,	rez.ve,	(rez.r2?rez.r2:rez.re),	rez.rm, separator, tex, nots);
		case 't': return chislitM(p1,	rez.te,	 rez.tm,				rez.tm, separator, tex, nots);
		case 'p': return chislitM(p1,	rez.pe,	 rez.pm,				rez.pm, separator, tex, nots);
		case 'i':
		default : return chislitM(p1,	rez.ie,	(rez.r2?rez.r2:rez.re),	rez.rm, separator, tex, nots);
	}
}
