...
function chislitM(p1, p2, p3, p4, o){
	let number;
	if (o.latex || ('latex_ts' in o)){
		if ('latex_ts' in o){
			number = p1.ts(o.latex_ts).ob$();
		} else {
			number = ('' + p1).ob$();
		}
	} else {
	...
	let separator = ('separator' in o) ? o.separator : ' ';


	return number + separator + chislit(p1, p2, p3, p4);
}

function chislitlx(p1, p2, p3, o){
/***/
	o = o || {};
	...
	switch(p3){
		case 'i': return chislitM(p1,	rez.ie,	(rez.r2?rez.r2:rez.re),	rez.rm, o);
		case 'r': return chislitM(p1,	rez.re,	 rez.rm,				rez.rm, o);
		case 'd': return chislitM(p1,	rez.de,	 rez.dm,				rez.dm, o);
		case 'v': return chislitM(p1,	rez.ve,	(rez.r2?rez.r2:rez.re),	rez.rm, o);
		case 't': return chislitM(p1,	rez.te,	 rez.tm,				rez.tm, o);
		case 'p': return chislitM(p1,	rez.pe,	 rez.pm,				rez.pm, o);
	}
	return chislitM(p1, rez.ie, (rez.r2?rez.r2:rez.re), rez.rm, o);
}
