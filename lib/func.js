...
function chislitM(p1,p2,p3,p4,separator){
	if(Object.prototype.toString.call(separator) !== '[object String]') {
		// Sometimes I hate JS!
		separator = ' ';
	}
	return p1.ts() + separator + chislit(p1,p2,p3,p4);
}
...
/***/
	...
	switch(p3){
		case 'i': return chislitM(p1,	rez.ie,	(rez.r2?rez.r2:rez.re),	rez.rm,separator);
		case 'r': return chislitM(p1,	rez.re,	 rez.rm,				rez.rm,separator);
		case 'd': return chislitM(p1,	rez.de,	 rez.dm,				rez.dm,separator);
		case 'v': return chislitM(p1,	rez.ve,	(rez.r2?rez.r2:rez.re),	rez.rm,separator);
		case 't': return chislitM(p1,	rez.te,	 rez.tm,				rez.tm,separator);
		case 'p': return chislitM(p1,	rez.pe,	 rez.pm,				rez.pm,separator);
	}
