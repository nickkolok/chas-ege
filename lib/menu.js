...
function generateTruncatedMenu(){
	...
	return '<center><a href="https://www.math.vsu.ru/chas-ege/doc/index.html" target="blank">Тренажёр "Час ЕГЭ"</a> разработан при <a href="https://www.math.vsu.ru/" target="blank">Математическом факультете ВГУ</a>.</center>';
}
