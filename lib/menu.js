...
function _getMenuModel(genJson, nastrCopy, obol) {
	...
	nastr_mat2013.nabor = { title:'../zdn/mat/mat.js' };

	//Математика ЕГЭ-2014
	var nastr_mat2014 = nastrCopy.clone();
	nastr_mat2014.nabor = { title:'../zdn/mat2014/mat2014.js' };

	//Математика ЕГЭ-2015 профильный
	var nastr_matege2015p=nastrCopy.clone();
	nastr_matege2015p.nabor={title:'../zdn/matege2015p/matege2015p.js'};

	//Математика ЕГЭ-2016 профильный
	var nastr_matege2016p=nastrCopy.clone();
	nastr_matege2016p.nabor={title:'../zdn/matege2016p/matege2016p.js'};

	//Математика ЕГЭ-2023 профильный
	var nastr_matege2023p=nastrCopy.clone();
	nastr_matege2023p.nabor={title:'../zdn/matege2023p/matege2023p.js'};

	//Математика ЕГЭ-2024 профильный
	var nastr_matege2024p=nastrCopy.clone();
	nastr_matege2024p.nabor={title:'../zdn/matege2024p/matege2024p.js'};

	//Математика ЕГЭ-2024 профильный, ФИПИ
	var nastr_matege2024pf=nastrCopy.clone();
	nastr_matege2024pf.nabor={title:'../zdn/matege2024p/matege2024p_fipi.js'};

	//Математика ОГЭ-2024 профильный
	var nastr_matoge2024=nastrCopy.clone();
	nastr_matoge2024.nabor={title:'../zdn/matoge2024/matoge2024.js'};

	//Математика ОГЭ-2024 профильный, ФИПИ
	var nastr_matoge2024f=nastrCopy.clone();
	nastr_matoge2024f.nabor={title:'../zdn/matoge2024/matoge2024_fipi.js'};

	//Тригонометрия
	var nastr_tri = nastrCopy.clone();
	nastr_tri.nabor = { title:'../zdn/tri/tri.js' };

	//Русский язык ЕГЭ-2014
	var nastr_rus2014 = nastrCopy.clone();
	nastr_rus2014.nabor = { title:'../zdn/rus2014/rus2014.js' };

	//Информатика ЕГЭ-2014
	var nastr_inf2014 = nastrCopy.clone();
	nastr_inf2014.nabor = { title:'../zdn/inf/inf.js' };

	//История: Перегудов
	var nastr_istpereg = nastrCopy.clone();
	nastr_istpereg.nabor = { title:'../zdn/istpereg/istpereg.js' };
	...
	return {
		...
		"Тесты": {
			"По предметам": {
				...
				"Математика: ЕГЭ-2024 (профильный, только ФИПИ)": obol + genJson(nastr_matege2024pf),
