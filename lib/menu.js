...
function _getMenuModel(genJson, nastrCopy, obol) {
	...
	nastr_matege2024pf.nabor={zagol:'../zdn/matege2024p/matege2024p_fipi.js'};

	//Математика ЕГЭ-2024 базовый
	var nastr_matege2024b=nastrCopy.clone();
	nastr_matege2024b.nabor={zagol:'../zdn/matege2024b/matege2024b.js'};
	...
	nastr_matoge2024.nabor = { zagol:'../zdn/matoge2024/matoge2024.js' };
	...
	return {
		...
		"Тесты": {
			"По предметам": {
				"Математика: ЕГЭ-2024 (базовый)": obol + genJson(nastr_matege2024b),
				...
				"Математика: ОГЭ-2024": obol + genJson(nastr_matoge2024),
