...
class RectangularPyramidWithRightAngledTriangleAtBase extends Pyramid {
    ...
    sideSurfaceArea() {
        return calculateTriangleArea(this.sideA,this.sideEdgeA,this.height)+calculateTriangleArea(this.sideB,this.sideEdgeB,this.height)+calculateTriangleArea(this.sideC,this.sideEdgeA,this.sideEdgeB)
    }
...
class RectangularPyramidWithRectangleAtBase extends Pyramid {
    ...
    sideSurfaceArea() {
        return calculateTriangleArea(this.sideA,this.sideEdgeA,this.height)+calculateTriangleArea(this.sideB,this.sideEdgeB,this.height)+calculateTriangleArea(this.sideB,this.sideEdgeA,this.sideEdgeC)+calculateTriangleArea(this.sideA,this.sideEdgeB,this.sideEdgeC);
    }
