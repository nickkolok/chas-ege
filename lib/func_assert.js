...
function genAssertAlmostInteger(number, message){
	genAssert((number).isAlmostInteger(), message || 'Число не должно иметь знаков после запятой');
}
...
function genAssertGraphIntersectsPointWithNeighborhood(f, x, y, epsilon, message) {
