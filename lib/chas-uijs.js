...
Number.prototype.fracstr=function(p1,str){'use strict';
	var a1={ch:this,zn:p1};
	if(p1.isString)
		return 
			a1.zn!=1?
...
String.prototype.ob$=function(){'use strict';
	return '$'+this+'$';
};
...
function sklonlxkand(slovo,p1,al){'use strict';
	if(lx[slovo]){
		if(al)
...
function strlxkand(slovo,p1,al){'use strict';
	var rez=setlx(slovo);
	var sl;
	if(!lxkand[slovo])
...
function loglxkand(slovo,p1){'use strict';
...
var nabor_rus2014='#nabor&nZad=3&adres=../zdn/rus2014/&name=rus2014&prefix=G&kat=';
...
predmet(nabor_rus2014,'Русский язык: часть');
...
//'25.10.2013 в 15-00 в ауд. 436 Главного корпуса ВГУ состоится<br/>бесплатная лекция проф. Глушко, главы экзаменационной <br/>комиссии по математике,  на тему "Решение задач С5".',
...
'Вы можете <a href="../doc/oprosy.html">проголосовать</a> за то, <br/>что будет добавлено в "Час ЕГЭ"<br/>в ближайшем еженедельном выпуске.',
