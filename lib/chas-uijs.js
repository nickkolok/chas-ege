...
document.write('	<li class="pureCssMenui"><a class="pureCssMenui" href="../doc/index.html"'+target+'><span>На главную</span></a></li>');
...
document.write('		<li class="pureCssMenui0"><a class="pureCssMenui0" href="../sh/otladka.html"'+target+'>Режим отладки шаблона</a></li>');
document.write('	</ul>');
...
document.write('	<ul class="pureCssMenum">');
document.write('		<li class="pureCssMenui0"><a class="pureCssMenui0" href="../doc/oprosy.html"'	+target+'>Опросы и голосования</a></li>');
document.write('		<li class="pureCssMenui0"><a class="pureCssMenui0" href="../doc/license.html"'	+target+'>Лицензия</a></li>');
document.write('		<li class="pureCssMenui0"><a class="pureCssMenui0" href="../doc/razrab.html"'	+target+'>Разработчики</a></li>');
document.write('		<li class="pureCssMenui0"><a class="pureCssMenui0" href="../doc/tech.html"'		+target+'>Техническое</a></li>');
document.write('		<li class="pureCssMenui0"><a class="pureCssMenui0" href="../doc/systreb.html"'	+target+'>Системные требования</a></li>');
document.write('		<li class="pureCssMenui0"><a class="pureCssMenui0" href="../doc/skachat.html"'	+target+'>Скачать программу</a></li>');
...
document.write('		<li class="pureCssMenui0"><a class="pureCssMenui0" href="../doc/istor.html"'	+target+'>История выпусков</a></li>');
document.write('		<li class="pureCssMenui0"><a class="pureCssMenui0" href="../doc/koncepc2.html"'	+target+'>Концепция</a></li>');
document.write('		<li class="pureCssMenui0"><a class="pureCssMenui0" href="../doc/ssylki.html"'	+target+'>Ссылки</a></li>');
document.write('	</ul>');
document.write('	<!--[if lte IE 6]></td></tr></table></a><![endif]--></li>');
...
if(bIE){
	...
	chas.integrate=function(href,strn,width,height){
		if(!height){
			height='1500';
		}
		if(!width){
