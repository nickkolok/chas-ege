...
if(nabor.zagol)
	addscript(nabor.zagol,'addscript(nabor.adres+\'upak.js\');');
'use_strict';
...
if(!svinta){
	...
	document.write('<!-- HotLog --><span id="hotlog_counter"></span><script type="text/javascript">var hotlog_counter_id = 2334044;var hotlog_hit = 37;var hotlog_counter_type = 68;</script><script src="http://js.hotlog.ru/counter.js" type="text/javascript" async="true"></script><noscript><a href="http://click.hotlog.ru/?2334044" target="_blank"><img src="http://hit37.hotlog.ru/cgi-bin/hotlog/count?s=2334044&im=68" border="0"title="HotLog" alt="HotLog"></a></noscript><!-- /HotLog -->');
}
'use strict';
