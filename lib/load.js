(function() {
	...
	var libList=[
		...
		choosePath('node_modules/nerdamer/all.min.js', 'ext/nerdamer.js'),
		'lib/mathjs_helpers.js',
		'lib/mathjs_rules.js',
		'lib/mathjs_functions.js',
		...
		//Cubic spline
		choosePath('node_modules/cubic-spline-browserified/cubic-spline-for-browser.js', 'ext/cubic-spline-for-browser.js'),

		//Planimetry
		choosePath('node_modules/flatten-shape-geometry/dist/bundle.js', 'ext/flatten-shape-geometry.js'),
		choosePath('node_modules/flatten-js-browserified/dist/flatten_js_browserified.js', 'ext/flatten_js_browserified.js'),
