...
d+'"></span></td>';e+="<td"+f+'><span class="vremya" id="vremyaB'+d+'"></span></td>'}$("#galki").html("<tr>"+a+'<td></td></tr><tr class="praviln">'+b+'<td><span id="pB"></span></td></tr><tr class="praviln">'+c+'<td><span class="kolvoprav" id="pravB"></span><br/>из<br/><span id="vsegB"></span></td></tr><td></td></tr><tr class="vremya">'+e)}sozdGalki();zagrUmka();veroyatn();
...
function vybrv(){for(var a=1;a<=nabor.nZad;a++)$("#cB"+a).not(":checked").click()}function obrabNaVremya(){$("#check-na-vremya").is(":checked")?$(".vremya").show():$(".vremya").hide()}$(obrabNaVremya);function obrabPraviln(){$("#check-praviln").is(":checked")?$(".praviln").show():$(".praviln").hide()}$(obrabPraviln);function vybr0(){for(var a=1;a<=nabor.nZad;a++)$("#cB"+a).removeAttr("checked")}var strelkaEst=1;
function strelkaDvig(){strelkaEst?($("#strelka").animate({left:"-=20"},{duration:1E3}),$("#strelka").animate({left:"+=20"},{duration:1E3,complete:strelkaDvig}),$("#sozd").animate({opacity:"0.5"},{duration:1E3}),$("#sozd").animate({opacity:"1"},{duration:1E3})):$("#strelka").remove()}strelkaDvig();$("#prov").hide();$("#podob").hide();galkiKat("#galki_kat","sluch");spoiler();$("#otv").keyup(function(a){if(nabor.mnogostrOtvet||flProv)return!0;if(13==a.keyCode)return prover(),!1});assertCheckability();
