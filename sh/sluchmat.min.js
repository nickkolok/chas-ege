...
var startShell=function(){sozdGalki();zagrUmka();veroyatn();$(obrabNaVremya);$(obrabPraviln);strelkaDvig();$("#prov").hide();$("#podob").hide();galkiKat("#galki_kat","sluch");spoiler();$("#otv").keyup(function(a){if(nabor.mnogostrOtvet||flProv)return!0;if(13==a.keyCode)return prover(),!1});assertCheckability()};
