...
mw.util.$content.find('h2').children('.editsection:first').clone().prependTo('#bodyContent').css('float','right').find('a').attr('title',zeroSectionTip).attr('href',wgScript+'?title='+mw.util.wikiUrlencode(wgPageName)+'&action=edit&section=0')}var hasClass=(function(){var reCache={}
...
/* cache key: ruwiki:resourceloader:filter:minify-js:7:4be2b9556a900dc4b3261d39fabe6245 */