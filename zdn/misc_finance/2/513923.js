...
massiv1[j]='$'+(S*massiv1[j]/10).ts()+'$';}
    ...
    NAtask.setTask({
        text: 'В '+
            ...
            ' '+g+' года планируется взять кредит в банке на сумму '+chislitM(S, 'миллион', 'миллиона', 'миллионов') + 
            ...
            '<table border="1" cellspacing="0" cellpadding="12">' +
             ...
             '</table>' +
            '</center><br/>' + //Центрирование и отступы вокруг таблицы
            'Найдите r, если общая сумма выплат составила '+v.ts()+' миллионов рублей.',
        answers: r,
    });
}, 100000);
//задана таблица долгов
//513923 513916 548496 549035
