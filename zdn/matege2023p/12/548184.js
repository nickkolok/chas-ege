...
massiv1[j]='$'+(S*massiv1[j]/10).ts()+'$';}
    ...
    NAtask.setTask({
        text: 'В '+sklonlxkand(om.months[monthIndex]).pe +' '+g+' года планируется взять кредит в банке на сумму '+chislitM(S, 'миллион', 'миллиона', 'миллионов') + 
            ' рублей на '+chislitM(m, 'год', 'года', 'лет') +'. Условия его возврата таковы:<br>'+
            ...
            '</table>' +
            '</center><br/>' + //Центрирование и отступы вокруг таблицы
            'Сколько миллионов рублей будет выплачено банку за первые '+chislitM(k, 'год', 'года', 'лет') +'?',
        answers: v,
    });
}, 100000);
