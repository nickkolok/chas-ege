(function() {
	...
	retryWhileError(function() {
		...
		NAtask.setTask({
			text: 'В цилиндрический сосуд налили $' + volume + '\\mbox{см}^3$ воды. ' +
				'Уровень воды при этом достигает высоты $' + height + '$см. ' +
				'В жидкость полностью погрузили деталь. ' +
				'При этом уровень жидкости в сосуде поднялся на $' + deltaHeight + '$см. ' +
				'Чему равен объем детали? Ответ выразите в $\\mbox{см}^3$.',
