(function () {
    ...
    retryWhileError(function () {
        ...
        let s = sl1();
        let nameFigure = [nameCone, nameSphere][s];
        let question = [nameFigure[0].toZagl() + [' конуса ', ' шара '][s] + ['равен', 'равна'][sklonlxkand(nameFigure[0]).rod] + ' $' + nameFigure[1].texsqrt(1) + (nameFigure[3] || '') + '$. Найдите ' + sklonlxkand(nameFigure[0]).ve + [' сферы', ' конуса'][s] + (nameFigure[2] || '') + '.',
        nameFigure[1 - s]
        ];
        ...
        NAtask.modifiers.multiplyAnswerBySqrt(2);
