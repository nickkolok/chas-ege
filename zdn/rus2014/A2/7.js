(function() {
	'use strict';
	chas2.task.setTask({
		text: 'В каком предложении вместо слова ВЗРЫВНОЙ нужно употребить слово ВЗРЫВЧАТЫЙ?' +
			'<br/>',
		answers: [
		...
		analys: 'ВЗРЫВНОЙ — относящийся к взрывам. По контексту подразумевается ВЗРЫВЧАТЫЙ (вещества всегда ВЗРЫВЧАТЫЕ, а не ВЗРЫВНЫЕ).',
	});
	AtoB();
