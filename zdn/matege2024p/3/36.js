(function() {
	retryWhileError(function() {
		...
		NAtask.setTask({
			text: 'В прямоугольном параллелепипеде $ABCDA_1B_1C_1D_1$ известны длины рёбер: ' + ['$AB=' + a + '$', '$AD=' +
					b + '$', '$AA_1=' + c + '$'
				].shuffleJoin(', ') + '. ' +
				'Найдите ' + question + ' угла между '+['прямыми','отрезками','лучами'].iz()+' $' + [letters1, letters2].shuffleJoin('$ и $') + '$.',
			answers: answ,
