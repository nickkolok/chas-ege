(function() { 'use strict'; retryWhileError(function() {
	...
	NAtask.setTask({
        ...
        нормального функционирования электросети общее сопротивление в ней должно быть не меньше ${R} Ом. Определите наименьшее возможное сопро-
        тивление R2 электрообогревателя. Ответ дайте в омах.`,
		answers: ans,
		authors: ['mcFrene'],
	});
