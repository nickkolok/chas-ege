(function() { 'use strict'; retryWhileError(function() {
	...
	NAtask.setTask({
        ...
        $f$ — частота отражённого от дна сигнала, регистрируемая приёмником (в МГц). Определите частоту отражённого сигнала в МГц, если скорость погружения батискафа равна ${v} м/с.`,
		answers: ans,
		authors: ['mcFrene'],
	});
