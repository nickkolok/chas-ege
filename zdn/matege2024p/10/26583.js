(function() { 'use strict'; retryWhileError(function() {
	...
	NAtask.setTask({
		text:
			...
			'и прибыл к финишу на ' + chislitlx(n, 'час') + ' раньше второго. ',
		questions: [
			{
				text:  the_orderToFind.toZagl() +' скорость ' + the_vehicleRacingOnRoad.re + ', '+ 'пришедшего к финишу первым. ',
				answers: x,
			},
			{
				text:  the_orderToFind.toZagl() +' скорость ' + the_vehicleRacingOnRoad.re + ', '+ 'пришедшего к финишу вторым. ',
				answers: x - a,
			},
		],
