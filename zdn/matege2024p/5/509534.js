	...
	retryWhileError(function() {
		...
		NAtask.setTask({
			...
			analys: `Всего имеется $n = ${n}$ элементарных исходов. Так как все они равновозможны, вероятность каждого равна $\\frac{1}{${n}}$.` +
					`<br/>Событию $\{X = ${targetX}\}$ благоприятствуют исходы, в которых значение случайной величины равно ${targetX}. Таких исходов ${countFavorable}.` +
					`<br/>Тогда вероятность события равна отношению числа благоприятных исходов к общему числу исходов: ` +
