...
Более того, камера зафиксировала ${chislitlx(N_other, 'случай')} ${otherVio.text}. Это нарушение наказывается штрафом в размере ${otherVio.fine} рублей (${otherVio.article}).
