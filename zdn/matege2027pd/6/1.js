(function() { 'use strict'; retryWhileError(function() {
	...
	if (displayMode === 0) {
		...
		condition = `на выигрыш в ${p[0]} рублей приходится ${c0.ts()} билетов,<br/>` +
					`на выигрыш в ${p[1]} рублей приходится ${c1.ts()} билетов,<br/>` +
					`на выигрыш в ${p[2]} рублей приходится ${c2.ts()} билетов,<br/>` +
					`на выигрыш в ${p[3]} рублей приходится ${c3.ts()} билетов,<br/>` +
					`на выигрыш в ${p[4]} рублей приходится ${c4.ts()} билетов.<br/>`;
	}
	...
	let analys = `Математическое ожидание случайной величины равно сумме произведений её возможных значений на вероятности этих значений.<br/>` +
		...
		`$$M(X) = ${p[0]} \cdot \frac{${c0.ts()}}{10000} + ${p[1]} \cdot \frac{${c1.ts()}}{10000} + ${p[2]} \cdot \frac{${c2.ts()}}{10000} + ${p[3]} \cdot \frac{${c3.ts()}}{10000} + ${p[4]} \cdot \frac{${c4.ts()}}{10000} = ${s.ts()}$$`;
