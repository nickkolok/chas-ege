...
window.vopr.text='$'+ver[0]+'=$<br/>';//Первый (нулевой!) из них пишем в условие
window.vopr.correctAnswers=[ver[1].ob$()];//Второй (первый!) "оборачиваем" в $ - отделитель формул - и объявляем верным ответом
window.vopr.incorrectAnswers=mas.matrToVect().ob$();//А всё остальное - куски других равенств - объявляем отвтеами неверными.
AtoB();
