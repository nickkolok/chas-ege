(function () {
    retryWhileError(function () {
        ...
        triangle.addVertexToConnectionMatrix(Object.values(triangle.heightEndPoints)[randomLine], ['A', 'B', 'C'][randomLine]);

        let height = Object.values(triangle.heightLengths)[randomLine];
