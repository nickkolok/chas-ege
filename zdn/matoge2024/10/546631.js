(function () {
    ...
    retryWhileError(function () {
        ...
        let colorsInstr = colors.slice(3,5).map(c => c.replace('ий', 'ей').replace('ый', 'ой'));

        genAssertZ1000(probability);

        NAtask.setTask({
            text: 'В магазине канцтоваров продаётся $' + total + '$ ручек: ' + '$' + c1 + '$ ' + colorsGen[0] + ', $' + c2 + '$ ' + colorsGen[1] + ', $' + c3 + '$ ' + colorsGen[2] + 
