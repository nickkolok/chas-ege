(function () {
    retryWhileError(function () {
        ...
        let angleA = new Angle(AB.pe, AB.ps, CD.pe).angleInDegrees;
        ...
        NAtask.setTask({
            text: `Угол $A$ четырёхугольника $ABCD$, вписан ного в окружность, равен $${angleA}^\\circ$. Найдите угол $C$ этого четырёхугольника. Ответ дайте в градусах.`,
            answers: 180 - angleA,
...
// https://oge.sdamgia.ru/problem?id=392118
