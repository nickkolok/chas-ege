...
window.vopr.text='На коллоквиуме по математическому анализу студенту достаётся один из вопросов. '+
...
window.vopr.correctAnswers=[(va+vb).ts()];

window.vopr.solution='Вероятность одного из несовместных событий равна сумме вероятностей этих событий:'+
