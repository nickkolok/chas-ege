...
window.vopr.text=t1+' стреляет по мишени один раз. В случае промаха '+
	...
	;
window.vopr.correctAnswers=[( v1? 1-(1-v)*(1-v) : (1-v)*(1-v) ).ts()];
window.vopr.solution='Вероятность того, что мишень будет поражена с первого раза, составляет $'+
