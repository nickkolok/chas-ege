...
var mesto=['фабрике','фабрике мягких игрушек','фабрике игрушек','фабрике керамической посуды','заводе','производстве','производстве дверных ручек'].iz();
...
} else if (mesto == 'фабрике игрушек'){
	deistvie=['выпущенных','изготовленных'].iz();
	predmet=sklonlxkand(['игрушка','машинка','кукла'].iz());
...
NAtask.setTask({
	text: 'На '+mesto+' '+def1+'% '+deistvie+' '+predmet.rm+' имеют дефект. '+
		...
		'что случайно выбранная при покупке '+predmet.ie+' '+nayti+'. Результат округлите до тысячных.',
