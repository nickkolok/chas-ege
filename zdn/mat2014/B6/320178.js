...
(function () {
    ...
    var device = ['калькулятора', 'смартфона', 'POS-терминала', 'вычислительного устройства', 'банкомата'].iz();
    ...
    NAtask.setTask({
        text: 'На клавиатуре ' + device + ' 10 цифр, от 0 до 9. ' +'Какова вероятность того, что случайно нажатая цифра ' + vopros + ' ' + naiti + '' + dopoln + '' + chislo2 + '?',
