...
retryWhileUndefined(function() {
	...
	case 1:
		text =
			'$y=f\'(x)$ - производная функции $f(x)$, определённой на интервале [-4;4]. Найдите количество точек экстремума функции';
		break;
	case 2:
		text =
			'$y=f(x)$, определённой на интервале [-4;4]. Найдите количество точек, где производная этой функции равна нулю';
		break;
	}
