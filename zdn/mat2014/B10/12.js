...
console.log('_AB='+_ab+'; _AC='+_ac+'; _HH = '+_hh);
...
window.vopr.dey=function(){
	...
	//* sA */ ct.fillKrug(sCube.lowAx, sCube.lowAy, 5); 
    //* sB */ ct.fillKrug(sCube.lowBx-Math.abs(sCube.lowBy-sCube.lowCy), sCube.lowBy, 5);
    //* sC */ ct.fillKrug(sCube.lowCx, sCube.lowCy, 5);
    //* sD */ ct.fillKrug(sCube.lowCx-Math.abs(sCube.lowBy-sCube.lowCy), sCube.lowBy, 5);
    //* sA' */ct.fillKrug(sCube.lowAx, sCube.lowAy+sCube.height, 5);
    //* sB' */ct.fillKrug(sCube.lowBx-Math.abs(sCube.lowBy-sCube.lowCy), sCube.lowBy+sCube.height, 5);
    //* sC' */ct.fillKrug(sCube.lowCx, sCube.lowCy+sCube.height, 5);

	//* A-A' */ct.drawLineSpec(bCube.lowAx, bCube.lowAy, bCube.lowAx, bCube.lowAx+bCube.height);
