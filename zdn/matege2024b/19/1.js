retryWhileError(function() {
	...
	var text = (v1 ?
		'Найдите неверных утверждений. В ответ кажите его номер.' :
		'Найдите верных утверждений. В ответ кажите его номер.'
	) + '<br/>';

	let ver = [
		//Список (на самом деле массив) правильных слов
	...
	let nev = [
		//Список (на самом деле массив) неправильных слов
