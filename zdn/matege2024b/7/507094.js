(function () {
	...
	retryWhileError(function () {
		/* На рисунке точками показано атмосферное потребление воды в некотором городе на протяжении трёх суток с 4 по 6 апреля 2013 года. Втечение суток потребление воды измеряется 4 раза: в 0:00, в 6:00, в 12:00 и в 18:00.По горизонтали указывается время и дата, по вертикали – потребление воды вмиллиметрах ртутного столба. Для наглядности точки соединены линиями.*/
