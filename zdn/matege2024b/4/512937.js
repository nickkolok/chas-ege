(function () {
	...
	retryWhileError(function () {
		...
		let pronoun = ['его', 'её', 'её', 'её', 'его', 'его', 'его', 'его', 'его'][rand];
		...
		NAtask.setTask({
			...
			text: 'Потенциальная энергия тела (в джоулях) в поле тяготения ' + planet.re + ' вблизи ' + pronoun + ' поверхности вычисляется по формуле $E = mgh$,' +
				...
				'Пользуясь этой формулой, ' + the_orderToFind + ' $m$ (в килограммах), если $g = ' + g + '$ $м/с^2$, $h = ' + h + '$ $м$,а $E = ' + E + '$ $Дж$.',
			answers: m,
