(function () {
	...
	retryWhileError(function () {
		...
		let minute = sl(1, rideTime - 2);
		let cost = price + 11 * (rideTime - minute);
		...
		NAtask.setTask({
			text:
				...
				'Если поездка длится $' + minute + '$ минут или более, ' +
				'то её стоимость (в рублях) рассчитывается по формуле $C =' + price + '+11 \\cdot (t - ' + minute + ')$, где $t$ – длительность поездки, ' +
