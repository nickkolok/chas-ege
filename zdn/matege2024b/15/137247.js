(function () {
    ...
    retryWhileError(function () {
        ...
        NAtask.setTask({
            text:
                govOrPriShare[0].toZagl() + ' принадлежит ' + persent + '% акций предприятия "' + nameOfCompany + '", ' +
                'остальные акции принадлежат ' + govOrPriShare[1] + '. ',
            questions: [
                {
                    text: 'Общая прибыль предприятия после уплаты налогов за год составила ' + companyProfit + ' млн. р. ' +
                ...
                {
                    text: 'Прибыль, которая досталась ' + [govOrPriShare[0], govOrPriShare[1]][rand] + ' составляет ' +
