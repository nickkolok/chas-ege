(function () {
    ...
    retryWhileError(function () {
        ...
        let longRivePart = shortRivePart + sl(3, 10, 1);
        ...
        NAtask.setTask({
            text:
                ...
                ', при этом одна из них длиннее другой на ' + (longRivePart - shortRivePart) * unitOfLenght + ' км. Найдите длину ' +
                riverLength + ' реки. Ответ дайте в километрах.',
            answers: [longRivePart * unitOfLenght, shortRivePart * unitOfLenght][rand],
        });
    }, 100);
})();
