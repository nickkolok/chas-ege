		...
		NAtask.setTask({
			...
			questions: [
				[{
					...
					text: `Одно из основани трапеции равно $${trp.lengthAB}$, боковая сторона, равная $${trp.lengthDA}$ образует с одним из оснований трапеции угол $150^\\circ$, площадь трапеции равна $${trp.area()}$. Найдите второе основание`,
