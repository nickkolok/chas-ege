(function() {
	retryWhileError(function() {
		...
		NAtask.setTask({
			text: `В параллелограмме $ABCD$ проведена бисекстриса угла $A$, пересекающая сторону CD в точке $K$. Найдите $KC$, если $${['DA', 'BC'].iz()}=${par.lengthDA}$, а периметр параллелограмма равен $${par.perimeter}$.`,
