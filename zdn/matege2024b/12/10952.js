(function() {
	retryWhileError(function() {
		...
		NAtask.setTask({
			text: `$${letters.join('')}$ – правильный девятиугольник. Найдите угол $${lettersRotate.join('')}$. Ответ дайте в градусах.`,
			answers: 20 * delta,
...
// https://base.mathege.ru/clones/?position=&parent=10952
