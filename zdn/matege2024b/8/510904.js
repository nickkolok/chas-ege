(function () {
	...
	retryWhileError(function () {
		...
		NAtask.setTask({
			text: `Школа приобрела ${items[0].re}, ${items[1].re}, ${items[2].re} и ${items[3].re}. Известно, что ${items[3].ie} дороже ${items[2].re}, а ${items[1].ie} дешевле ${items[2].re} и дешевле ${items[0].re}. Выберите утверждения, которые ` + (rand ? 'неверны' : 'верны') +
