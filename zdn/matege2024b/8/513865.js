(function () {
	...
	retryWhileError(function () {
		...
		NAtask.setTask({
			text: `Каждый раз, когда ${girl.ie} приезжает в деревню к ${relative.de} в гости, ${relative.de} заплетает ей косички. Также ${girl.ie} заплетает себе косички всегда, когда идёт на ${activity.ve}. ` +
