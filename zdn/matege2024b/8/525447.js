(function () {
	...
	retryWhileError(function () {
		...
		let correct = [
			`Найдётся ${minNone} кружек с чаем без сахара и лимона.`,
			`Не найдётся ${lemon + 1} кружек с чаем без сахара, но с лимоном.`,
			`Максимум ${lemon} кружек с лимоном могут быть без сахара.`,
			`Минимум ${minNone} кружек ничем не дополнены.`
		];
		let wrong = [
			`Найдётся ${lemon} кружки с чаем с лимоном, но без сахара.`,
		...
		NAtask.setTask({
			text: `На столе стоят ${total} кружек с чаем. В ${sugar} из них чай с сахаром, а в остальных — без сахара. В ${lemon} из этих ${total} кружек официант собирается положить по дольке лимона.` +
