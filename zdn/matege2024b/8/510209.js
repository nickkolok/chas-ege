(function () {
	...
	retryWhileError(function () {
		...
		NAtask.setTask({
			text: `Среди тех, кто зарегистрирован в «${pairs[0]}», есть ${peopleImGroup}. Среди ${people.rm + group} есть те, кто зарегистрирован в «${pairs[1]}». Выберите утверждения, которые ` + (rand ? 'неверны' : 'верны') +
