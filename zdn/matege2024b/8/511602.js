(function () {
	...
	retryWhileError(function () {
		...
		let correct = [
			...
			`${female[1].ie} живёт в доме выше, чем дом в котором живёт ${male[1].ie}.`,
			`В доме ${male[0].re} больше этажей, чем в доме ${male[1].re}.`,
			`${male[1].ie} живёт в самом малоэтажном доме среди перечисленных четырёх.`
		];
		let wrong = [
