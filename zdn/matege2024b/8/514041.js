(function () {
	...
	retryWhileError(function () {
		...
		let correct = [
			'Найдётся $' + Math.max(1, count2 - drawn) + '$ ' + colorsRM[1] + ' шарика без рисунков.',
			'Не найдётся $' + (drawn + sl(1, 5)) + '$ ' + colorsRM[1] + ' шариков с рисунками.',
			'Среди нарисованных шариков может не быть ни одного ' + colorsRE[2] + '.',
			'Максимум $' + count2 + '$ ' + colorsRM[1] + ' шариков без рисунков.'
		];

		let wrong = [
			'Если шарик ' + colors[0] + ', то на нём есть рисунок.',
			'Найдётся $' + drawn + '$ ' + colorsRM[0] + ' шарика с рисунками.',
