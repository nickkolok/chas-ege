(function () {
	...
	retryWhileError(function () {
		...
		let correct = [
			...
			`Не может оказаться больше  ${chislitlx(maxBoth, bread, 'r')}, посыпанных и сахаром, и корицей.`,
		...
		NAtask.setTask({
			text: `Повар испёк ${chislitlx(total, bread)}, из них ${chislitlx(cinnamon, bread,'v')} он посыпал корицей, а ${chislitlx(sugar, bread,'v')} посыпал сахаром. Выберите одно или несколько утверждений, которые ` +
