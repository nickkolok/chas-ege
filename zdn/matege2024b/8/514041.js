(function () {
	...
	retryWhileError(function () {
		...
		NAtask.setTask({
			text: `Повар испёк ${chislitlx(total, bread)}, из них ${chislitlx(cinnamon, bread)} он посыпал корицей, а ${chislitlx(sugar, bread)} посыпал сахаром. Выберите одно или несколько утверждений, которые ` +
