(function () {
	...
	retryWhileError(function () {
		...
		let correct = [
			`Найдётся ${minNone} машин, в которых не нужно менять ни колодки, ни фильтр.`,
			`Не найдётся ${maxBoth + 1} машин, в которых нужно менять и колодки, и фильтр.`,
			`Максимум ${maxBoth} машин требуют замены обоих деталей.`,
			`Минимум ${minNone} машин не требуют никакой замены.`
		];
		let wrong = [
			`Найдётся ${maxBoth + 1} машин, в которых нужно поменять и колодки, и фильтр.`,
		...
		NAtask.setTask({
			text: `Диагностика ${total} машин в автосервисе показала, что у ${pads} машин нужно заменить тормозные колодки, а у ${filter} машин — заменить воздушный фильтр (колодки и фильтр требуют замены независимо друг от друга). ` +
