(function () {
	...
	retryWhileError(function () {
		...
		let correct = [
			...
			`Знающих только ${lang[0]} на ${(firstLang - secondLang).abs()} ${chislitM((firstLang - secondLang).abs(), 'человека', 'человека', 'человек')} ${moreOrLess}, чем тех, кто знает только ${lang[1]}.`,
		];
		let wrong = [
