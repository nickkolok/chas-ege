(function () {
	...
	retryWhileError(function () {
		...
		let correct = [
			`В ${town} нет жилого дома высотой ${minHeight - sl(1,2)} метра.`,
			`Высота любого жилого дома в ${town} не меньше ${minHeight - sl(1,2)} метров.`,
			`Максимальная высота меньше ${maxHeight} метров.`,
			`Минимальная высота превышает ${minHeight - sl(1,2)} метр.`
		];
		let wrong = [
			`В ${town} есть жилой дом высотой ${maxHeight} метров.`,
			`Разница в высоте любых двух домов больше ${maxHeight - minHeight + sl(5,10)} метров.`,
			`Существует дом высотой ${minHeight - sl(1,2)} метра.`,
