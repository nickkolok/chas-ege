(function () {
	...
	retryWhileError(function () {
		...
		NAtask.setTask({
			text: `Кошка ${names[0].ie} весит на ${chislitlx(weightFirst,'килограмм')} больше кошки ${names[1].re}, а кошка ${names[2].ie} на ${chislitlx(weightSecond,'килограмм','v')} легче кошки ${names[1].re}. Выберите утверждения, которые ` + (rand ? 'неверны' : 'верны') + ` при указанных условиях.` +
