(function () {
	...
	retryWhileError(function () {
		...
		let correct = [
			`В этой компании найдётся хотя бы ${chislitM(minBoth,'человек','человека','человек')}, пользующихся обеими сетями.`,
			`Не более ${chislitM(maxBoth,'человека','человек','человек')} из этой компании пользуются обеими сетями.`,
		...
		let wrong = [
			`В этой компании найдётся ${chislitM(total - ok,'человек','человека','человек')}, которые не пользуются ни сетью «${website[0]}», ни сетью «${website[1]}».`,
