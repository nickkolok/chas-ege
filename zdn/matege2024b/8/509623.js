(function () {
	...
	retryWhileError(function () {
		...
		let correct = [
			`В этой компании найдётся хотя бы ${chislitlx(minBoth,'человек','i')}, пользующихся обеими сетями.`,
			`Не более ${chislitlx(maxBoth,'человек','r')} из этой компании пользуются обеими сетями.`,
		...
		let wrong = [
			`В этой компании найдётся ${chislitlx(total - ok,'человек','i')}, которые не пользуются ни сетью «${website[0]}», ни сетью «${website[1]}».`,
