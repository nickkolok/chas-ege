(function () {
	...
	retryWhileError(function () {
		...
		let correct = [
			...
			`Не более ${chislitlx(maxBoth,'человек','v')} из этой компании пользуются обеими сетями.`,
		...
		let wrong = [
			`В этой компании найдётся ${chislitlx(total - ok,'человек','v')}, которые не пользуются ни сетью «${website[0]}», ни сетью «${website[1]}».`,
