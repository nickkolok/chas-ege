(function () {
	...
	retryWhileError(function () {
		...
		NAtask.setTask({
			text: `В некоторый момент температура воздуха в ${city[0].pe} была равна ${tempA}$^{\\circ}$C. В этот же момент в ${city[1].pe} было на ${colder}$^{\\circ}$C холоднее, чем в ${city[0].pe}, а в ${city[2].pe} было на ${hotter}$^{\\circ}$C теплее, чем в ${city[0].pe}.` +
