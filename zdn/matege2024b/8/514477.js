(function () {
	...
	retryWhileError(function () {
		...
		let correct = [
			...
			`${city[0].ie} теплее ${city[1].re} на ${chislitlx(colder,'градус')}.`,
			`${city[2].ie} теплее ${city[0].re} на ${chislitlx(hotter,'градус')}.`
		];
		let wrong = [
		...
		NAtask.setTask({
			text: `В некоторый момент температура воздуха в ${city[0].pe} была равна ${chislitlx(tempA,'градус')}. В этот же момент в ${city[1].pe} было на ${chislitlx(colder,'градус')} холоднее, чем в ${city[0].pe}, а в ${city[2].pe} на ${chislitlx(hotter,'градус')} теплее, чем в ${city[0].pe}.` +
