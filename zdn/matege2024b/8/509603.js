(function () {
	...
	retryWhileError(function () {
		...
		let subject = ['физике', 'математике', 'химии', 'русскому', 'географии', 'биологии', 'обществознанию', 'истории'].iz(2);
		...
		let wrong = [
			`Если телефон ${teacherName.re} ${teacherSurname.re} включён, значит, он ведёт урок ${subject[1]}.`,
