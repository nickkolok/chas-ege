(function () {
	...
	retryWhileError(function () {
		...
		NAtask.setTask({
			text: `${chislitlx(students,`выпускник`)} одного из одиннадцатых классов сдавали ЕГЭ по ${subject}. Самый низкий полученный балл, полученный в этом классе, был равен ${minScore}, а самый высокий — ${maxScore}. Выберите одно или несколько утверждений, которые ` +
