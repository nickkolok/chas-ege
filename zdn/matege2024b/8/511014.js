(function () {
	...
	retryWhileError(function () {
		...
		NAtask.setTask({
			text: `${chislitlx(students,`выпускник`)} одного из одиннадцатых классов сдавали ЕГЭ по ${subject}. Самый низкий полученный балл был равен ${minScore}, а самый высокий — ${maxScore}. Выберите одно или несколько утверждений, которые ` +
