(function () {
	...
	retryWhileError(function () {
		...
		let correct = [
			`В этой фирме хотя бы ${minBoth} человек знают и ${lang[0]}, и ${lang[1]} языки.`,
			`Не более ${maxBoth} человек из этой фирмы знают и португальский, и ${lang[1]} языки.`,
		...
		NAtask.setTask({
			text: `В фирме работает ${chislitlx(total, 'человек')}, из них ${chislitlx(firstLang, 'человек')} знают ${lang[0]} язык, а ${chislitlx(secondLang, 'человек')} — ${lang[1]}. Выберите одно или несколько утверждений, которые ` +
