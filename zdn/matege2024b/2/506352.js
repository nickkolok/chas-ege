...
let arrayObjects = [verySmallObject[sluchIndexVerySmallObject][0], smallObject[sluchIndexSmallObject][0], mediumObject[
	sluchIndexMediumObject][0], bigObject[sluchIndexBigObject][0]];
...
let arrayMass = [massMg + ' мг', massG + ' г', massKg + ' кг', parseFloat((massT).toFixed(1)) + ' т'];
let answer = 'A) ' + arrayAnswer[0] + ' B) ' + arrayAnswer[1] + ' C) ' + arrayAnswer[2] + ' D) ' + arrayAnswer[3]

NAtask.setTask({
	text: ' ' + ' A) ' + massWord + ' ' + arraySluchObjects[0] + ' B) ' + massWord + ' ' + arraySluchObjects[1] + ' C) ' +
		massWord + ' ' + arraySluchObjects[2] +
