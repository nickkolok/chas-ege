...
let massKg;
let massT;
let sluchMediumObject = ['холодильника', 'человека', ' книжного шкафа'].iz();
let verySmallObject = ['таблетки лекарства', 'комара', 'мухи', 'божьей коровки', 'капли воды', 'иголки', 'пуговицы'];
let smallObject = ['монеты', 'малины', 'клубники', 'вилки', 'яйца', 'ножниц', 'птицы', 'компьютерной мыши', ['картофеля', 'яблока', 'помидора'].iz()];
let mediumObject = ['коляски', 'собаки', 'коробки с книгами', 'кресла', sluchMediumObject, sluchMediumObject, sluchMediumObject];
let bigObject = [['машины', 'фонарного столба'].iz(), 'морского ската', ['бегемота', 'трактора'].iz(), 'носорога', 'индийского слона', 'касатки', 
['грузовика', 'бульдозера'].iz(), 'африканского слона', 'автобуса', 'фуры', 'гусенечного трактора', 'танка'];
