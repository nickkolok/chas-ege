(function() { 'use strict'; retryWhileError(function() {
	...
	NAtask.setTask({
		...
		b+'. Они одновременно начали отвечать на вопросы теста, и '+rebenok.ie+' закончил свой тест позже '+rebenoka.re+' на '+chislitlx(c,'минута')+'. Сколько вопросов содержит тест?',
		answers: v,
		authors: ['VeronikaKit'],
	});
