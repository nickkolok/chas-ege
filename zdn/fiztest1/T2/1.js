...
NAtask.setTask({
    text:"Как изменится "+vel[v2]+" колебаний груза на пружине, если маccу груза "+izm[v1]+"ть в "+chislitlx(raz*raz,"раз")+"?",
    ...
    analys:"Период прямо пропорционален квадратному корню из массы. "+
