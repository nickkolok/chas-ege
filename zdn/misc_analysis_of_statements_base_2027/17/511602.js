(function () {
	...
	retryWhileError(function () {
		...
		let correct = [
			...
			`В доме ${male[0].re} меньше этажей, чем в доме ${female[0].re}, но больше, чем в доме ${male[1].re}.`
		];
		let wrong = [
			...
			`В доме ${female[1].re} больше этажей, чем в доме ${female[0].re}, но меньше, чем в доме ${male[0].re}.`,
