...
## Чертёж объёмных фигур (3D)

При построении чертежей объёмных фигур (призм, пирамид и т.д.) часто используется матрица смежности `connectionMatrix`.
...
Такой формат позволяет компактно задавать рёбра графа без лишних нулей и идеально интегрируется с `CanvasRenderingContext2D.prototype.drawFigure`.
